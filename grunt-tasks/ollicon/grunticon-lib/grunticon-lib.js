...
(function(){
	...
	var jsp = uglify;
	var DirectoryColorfy = require( "../directory-colorfy/directory-colorfy.js" );
	var DirectoryEncoder = require( "../directory-encoder/directory-encoder.js" );
	var svgToPng = require( "svg-to-png" );
	var _ = require( "lodash" );
	_.mixin({ 'defaultsDeep': require('merge-defaults') });

	var loadCSSpath = path.join( __dirname, "..", "static");
	...
	Grunticon.generateLoader = function( opts ){
		...
		var loadCSS = fs.readFileSync(loadCSSpath+"/loadCSS.js").toString( "utf-8" );
		var onloadCSS = fs.readFileSync(loadCSSpath+"/onloadCSS.js").toString( "utf-8" );
