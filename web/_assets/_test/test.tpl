<div class="content-container baseline">
    ...
    <div class="content content-width">
        <div data-reflow class="box pic" style="padding-bottom:<?= 1149 * 100 / 1920 ?>%;">
            ...
            <div class="caption">
                <div class="caption-text">Picture: a nice pic of my dog</div>
            </div>
        </div>
        <p><i data-icon-embed class='icon-invader'></i> Erinnerungen, <a href='#'>Prophezeiungen</a>,
            Fantasiegespinste und <a href='#'>Liebe</a>, Vergangenheit, Zukunft und der Augenblick des Traums
            dazwischen -&nbsp;sie alle schaffen ein Land, das einen einzigen, unsterblichen Tag lang existiert.</p>
        <p>Das zu wissen, ist <a href='#'>Weisheit</a>. Das zu nutzen, ist <a href='#'><strong>'Kunst'</strong></a>.
            <i data-icon-embed class='icon-invader'></i></p>
        ...
        <figure class='center' data-reflow style="display:block;max-width:560px;width:100%;">
            <div class="box pic" style="padding-bottom:<?= 840 * 100 / 560 ?>%;">
                <iframe scrolling='no' data-src='images/faultier.jpg' data-type="img"
                ...
                <div class="caption">
                    <div class="caption-text">Picture: just relaxing</div>
                </div>
            </div>
        ...
        <div data-reflow class="box pic" style="padding-bottom:<?= 250 * 100 / 640 ?>%;">
            <iframe scrolling='no' data-src="http://lorempixel.com/640/250/?v=<?= rand(1, 99) ?>" data-type="img"
                    allowtransparency='true'></iframe>
        ...
        <div data-reflow class="box pic" style="padding-bottom:<?= 480 * 100 / 640 ?>%;">
            <iframe scrolling='no' data-src='http://lorempixel.com/640/480/?v=<?= rand(1, 99) ?>' data-type="img"
                    allowtransparency='true'></iframe>
